...
# e.g. from api.views import LoginView  ← still works
...
__all__ = [
    ...
    # Resumes
    "ResumeListCreateView", "ResumeDetailView", "ResumeScreenView", "RequirementResumesView","ResumeStageUpdateView"
    # Requirements
    ...
    # Interviews
    "InterviewListCreateView", "InterviewDetailView", "InterviewSendEmailView","InterviewSendAllEmailsView"
]